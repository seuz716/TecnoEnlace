...
from .views import (
    ...
    add_to_cart, enviar_whatsapp, cart_count, PedidoCreateView, get_cart_count, actualizar_cantidad
)
...
urlpatterns = [
    ...
    path('update/<int:producto_id>/', actualizar_cantidad, name='actualizar_cantidad'),
