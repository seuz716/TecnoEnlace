...
SECRET_KEY = os.getenv('SECRET_KEY') or 'django-insecure-replace-this-in-production'
...
# Database Configuration (SQLite for free hosting)
DATABASES = {
    'default': {
...
# Security settings (adjust in production)
